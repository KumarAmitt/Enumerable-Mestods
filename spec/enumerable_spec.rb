...
RSpec.describe Enumerable do
  ...
  describe '#my_select' do
    ...
    it 'should return an array where the elements are elements of the original array where the block result in true' do
  ...
  describe '#my_map' do
    ...
    it 'returns array of strings when given array of integers' do
      expect(a.my_map(&:to_s)).to eq(%w[5 3 2 4])
    end
  end
  ...
  describe '#my_inject' do
    ...
    it 'returns the accumulative result when given starting value and a unary operator' do
